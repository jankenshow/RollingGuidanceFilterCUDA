...
def test_rgf_identity():
    ...
    out = rgf.rolling_guidance_filter(img, sigma_s=3.0, sigma_r=10.0, iterations=3)
    ...
    out_gray = rgf.rolling_guidance_filter(gray, sigma_s=3.0, sigma_r=10.0, iterations=3)
    ...
    out = rgf.rolling_guidance_filter(img, sigma_s=3.0, sigma_r=25.0, iterations=4)
    end_time = time.time()
